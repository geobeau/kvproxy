...
type KvproxyOrca struct {
	l1  handlers.Handler
	res protocol.Responder
}

func Kvproxy(l1, l2 handlers.Handler, res protocol.Responder) orcas.Orca {
	return &KvproxyOrca{
		l1:  l1,
		res: res,
	}
...
func (l *KvproxyOrca) Set(req common.SetRequest) error {
...
func (l *KvproxyOrca) Add(req common.SetRequest) error {
	// Add is not yet implemented.
	log.Println("[WARN] Add command not supported by kvproxy's orchestrator")
	return common.ErrUnknownCmd
}

func (l *KvproxyOrca) Replace(req common.SetRequest) error {
...
func (l *KvproxyOrca) Append(req common.SetRequest) error {
	// Append is not yet implemented.
	log.Println("[WARN] Append command not supported by kvproxy's orchestrator")
	return common.ErrUnknownCmd
}

func (l *KvproxyOrca) Prepend(req common.SetRequest) error {
	// Prepend is not yet implemented.
	log.Println("[WARN] Prepend command not supported by kvproxy's orchestrator")
	return common.ErrUnknownCmd
}

func (l *KvproxyOrca) Delete(req common.DeleteRequest) error {
...
func (l *KvproxyOrca) Touch(req common.TouchRequest) error {
	// Touch is not yet implemented.
	log.Println("[WARN] Touch command not supported by kvproxy's orchestrator")
	return common.ErrUnknownCmd
}

func (l *KvproxyOrca) Get(req common.GetRequest) error {
...
func (l *KvproxyOrca) GetE(req common.GetRequest) error {
	// The L1OnlyCassandra orca does not support getE, only L1L2 does (see the old l1l2 branch).
	log.Println("[WARN] Use of unsupported GetE in kvproxy's orchestrator")
	return common.ErrUnknownCmd
}

func (l *KvproxyOrca) Gat(req common.GATRequest) error {
	// Get and Touch is not yet implemented.
	log.Println("[WARN] Get & Touch (GAT) command not supported by kvproxy's orchestrator")
	return common.ErrUnknownCmd
}

func (l *KvproxyOrca) Noop(req common.NoopRequest) error {
	return l.res.Noop(req.Opaque)
}

func (l *KvproxyOrca) Quit(req common.QuitRequest) error {
	return l.res.Quit(req.Opaque, req.Quiet)
}

func (l *KvproxyOrca) Version(req common.VersionRequest) error {
	return l.res.Version(req.Opaque)
}

func (l *KvproxyOrca) Unknown(req common.Request) error {
	return common.ErrUnknownCmd
}

func (l *KvproxyOrca) Error(req common.Request, reqType common.RequestType, err error) {
	var opaque uint32
	var quiet bool
